...
void print_tuple(T &&t, std::index_sequence<Idxes...>);
template <typename... Ts>
void print(std::tuple<Ts...> &&t);
template <typename... Ts>
void print(std::stack<Ts...> &&st);
template <typename... Ts>
void print(std::queue<Ts...> &&que);
template <typename... Ts>
void print(std::priority_queue<Ts...> &&pque);
